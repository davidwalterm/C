...
//Driver code
int main(){
    //variable declaration after structure template initialization
    //with initializer list and designated initializer list
    struct str1 var1={1, 'A', 1.00, "GeeksForGeeks"},var2;
    struct str2 var3={.ff=5.00, .ii=5, .cc='a'};

    //copying structure using assignement operator
    var2 = var1;
